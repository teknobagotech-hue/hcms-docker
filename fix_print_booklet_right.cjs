...
const mediaPrintCSSOld = `
        @media print {
          @page { margin: 0; size: 5.5in 8.5in; }
          html, body { width: 5.5in; height: 8.5in; margin: 0; padding: 0; overflow: hidden; background: white; display: block; position: relative; }
          .print-container { 
            position: absolute;
            left: 0;
            top: 0;
...
console.log('Fixed CSS positioning to LANDSCAPE BOOKLET RIGHT HALF!');
